...
Several pieces of relevant program code are included for further reference. They are demarcated by their filename, and their type (shader, \texttt{C++} code, etc) is clearly indicated.
