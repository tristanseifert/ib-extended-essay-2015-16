...
\begin{table}[!htbp]	
	...
	\begin{tabularx}{0.88\textwidth}{| r | c | c | >{\tt}X |}	
		\hline
		\rowcolor{HeaderGray}
		\multicolumn{2}{|c|}{\textbf{Running Time}} & \textbf{Self (ms)} & \multicolumn{1}{ c |}{\textbf{Symbol Name}} \\
		\hline
...
\begin{figure}[!htbp]
  \centering
  \subfloat[With FXAA]{\includegraphics[width=0.49\textwidth, frame]{images/fxaa_out@8x.png}\label{fig:f31}}
  \hfill
  \subfloat[Without FXAA]{\includegraphics[width=0.49\textwidth, frame]{images/bloom_hdr_out@8x.png}\label{fig:f32}}
